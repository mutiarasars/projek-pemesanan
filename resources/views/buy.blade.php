    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <p></p>
                <div class="card-body">
                    <form method="POST" action="{{ route('beli.send', $categories->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="no_telpon" type="number" class="form-control @error('no_telpon') is-invalid @enderror" name="no_telpon" value="" required autocomplete="no_telpon" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="input1" type="number" class="form-control @error('qty') is-invalid @enderror" name="qty" value="24" required autocomplete="qty" autofocus  onkeyup="multiplication()";>
                                @error('qty')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="name_product" type="text" class="form-control @error('name_product') is-invalid @enderror" name="name_product" value="" required autocomplete="name_product" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="description" required autocomplete="description" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="warna" type="text" class="form-control @error('warna') is-invalid @enderror" name="warna" value="warna" required autocomplete="warna" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="uk_panjang" type="number" class="form-control @error('uk_panjang') is-invalid @enderror" name="uk_panjang" value="" required autocomplete="uk_panjang" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="uk_lingkar" type="number" class="form-control @error('uk_lingkar') is-invalid @enderror" name="uk_lingkar" value="" required autocomplete="uk_lingkar" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="uk_pinggang" type="number" class="form-control @error('uk_pinggang') is-invalid @enderror" name="uk_pinggang" value="" required autocomplete="uk_pinggang" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="uk_pundak" type="number" class="form-control @error('uk_pundak') is-invalid @enderror" name="uk_pundak" value="" required autocomplete="uk_pundak" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="uk_lengan" type="number" class="form-control @error('uk_lengan') is-invalid @enderror" name="uk_lengan" value="" required autocomplete="uk_lengan" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="input2" type="decimal" class="form-control @error('price') is-invalid @enderror" name="" value="{{ $categories->price }}" required autocomplete="price" autofocus readonly onkeyup="multiplication();">
